...
extern "C"
{
JNIEXPORT void JNICALL Java_ru_mikheev_texturedcube_NativeLibrary_init(JNIEnv *env, jclass obj, jint width,
                                                                       jint height)
{
    setupGraphics(width, height);
}
    JNIEXPORT void JNICALL Java_ru_mikheev_texturedcube_NativeLibrary_step(
